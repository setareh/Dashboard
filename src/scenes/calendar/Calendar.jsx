...
export default function Calendar() {
    ...
    const handleDateClick = (selected) => {
        const title = prompt(`Please enter a new title fro your event`);
  ...
  return (
    <Box m="20px">
        <Header title='Calendar' subtitle='Full calenadr interaction page' />
            ...
            <Box flex='1 1 100%' ml='15px'>
                  <FullCalendar
                    ...
                    initialEvents={[
                        ...
                        {id:'4321', title: 'Time event', date: '2022-11-30'}
                    ]}
